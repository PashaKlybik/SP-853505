...
void CreateControls(HWND hwnd) {
	hTextEdt = CreateWindowEx(
		...
		5, WND_HEIGHT - 140, WND_WIDTH / 2 - 15, 25,
		hwnd,
		(HMENU)ID_EDIT,
	...
	hLeftListBox = CreateWindow(L"listbox", NULL,
		...
		5, 0, WND_WIDTH / 2 - 20, WND_HEIGHT - 150,
		hwnd, (HMENU)ID_LIST1,
		(HINSTANCE)GetWindowLong(hwnd, GWL_HINSTANCE),
		NULL);
	hRightListBox = CreateWindow(L"listbox", NULL,
		WS_CHILD | WS_VISIBLE | LBS_STANDARD |
		LBS_WANTKEYBOARDINPUT | LBS_MULTIPLESEL,
		WND_WIDTH / 2, 0, WND_WIDTH / 2 - 30, WND_HEIGHT - 150,
		hwnd, (HMENU)ID_LIST2,
		(HINSTANCE)GetWindowLong(hwnd, GWL_HINSTANCE),
		NULL);
	hToRightBttn = CreateWindow(
		...
		2 * WND_WIDTH / 4 + 10, WND_HEIGHT - 90, 100, 30,
	...
	hClearBttn = CreateWindow(
		...
		L"CLEAR",
		WS_VISIBLE | WS_CHILD | WS_BORDER,
		WND_WIDTH / 4 + 10, WND_HEIGHT - 90, 100, 30,
	...
	hDeleteBttn = CreateWindow(
		...
		L"DELETE",
		WS_VISIBLE | WS_CHILD | WS_BORDER,
		3 * WND_WIDTH / 4 + 10, WND_HEIGHT - 90, 100, 30,
